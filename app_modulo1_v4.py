...
def generar_pdf(datos_personales, resultados, comparativo, global_diag, imagenes):
    ...
    pdf.multi_cell(0, 8, "Los valores se obtuvieron mediante análisis de frecuencia (FFT) en los tres ejes de aceleración. Se estima la frecuencia dominante del temblor, la variabilidad (varianza), el valor cuadrático medio (RMS) y el desplazamiento máximo (amplitud estimada del temblor).")
    pdf.ln(2)
    ...
    for test, eje, img in imagenes:
        ...
        pdf.set_font("Arial", '', 9)
        pdf.multi_cell(0, 8, "Gráfico de transformada rápida de Fourier (FFT) mostrando la amplitud estimada del temblor en función de la frecuencia.")
